...
public class TestServicioActualizarAlias {
    @Mock
    ...
    @Test
    void testActualizarAliasConExito() throws CuentaNoEncontradaException, CuentasVaciasException, ClienteNoEncontradoException {
        long dni = 12345678L;
        long cbu = 11111111L;
    ...
    @Test
    void testActualizarAliasClienteNoEncontrado() {
        // Preparo datos de entrada
        long dni = 12345678L;
        long cbu = 11111111L;
        String nuevoAlias = "nuevoAlias";

        // Mockeo la búsqueda del cliente y me devuelve null
    ...
    @Test
    void testActualizarAliasCuentasVacias() {
        // Preparo datos de entrada
        long dni = 12345678L;
        long cbu = 11111111L;
        String nuevoAlias = "nuevoAlias";
        ...
        // Llamo al método y espero la excepción
        CuentasVaciasException exception = assertThrows(CuentasVaciasException.class,
                () -> servicioCuentas.actualizarAlias(dni, cbu, nuevoAlias));
    ...
    @Test
    void testActualizarAliasCuentaNoEncontrada() {
        // Preparo datos de entrada
        long dni = 12345678L;
        long cbu = 11111111L;
        String nuevoAlias = "nuevoAlias";
